...
Version: 2.0.2 - Refined by Zillinium, Cleaned up by Happyrobot33
Description:
   ...
   - access it using <script type="text/javascript" src="path/to/file/counter.php?show=this"></script> 
   
   CUSTOMIZATION
   - There is variables that affect what is shown
   - At the bottom of the script, you can change the output HTML code to add style / class for visual customization
...
// Text before total hits
$beforeTotalText = "Total Visits: ";

// Text before unique hits
$beforeUniqueText = "Unique Visitors: ";

// Text before current user IP
$beforeIP = "You are : ";
